...
import com.example.stpos.databinding.FragmentCancelInvoiceBinding;
...
public class CancelInvoiceFragment extends Fragment {

    public FragmentCancelInvoiceBinding binding;
    Api api;
    ...
    public static CancelInvoiceFragment newInstance(String param1, String param2) {
        CancelInvoiceFragment fragment = new CancelInvoiceFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      //  return inflater.inflate(R.layout.fragment_cancel_invoice, container, false);
        binding = FragmentCancelInvoiceBinding.inflate(inflater, container, false);
