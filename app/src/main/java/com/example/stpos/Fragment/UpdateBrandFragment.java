...
import com.example.stpos.databinding.FragmentUpdateBrandBinding;
...
public class UpdateBrandFragment extends Fragment {
    ...
    public FragmentUpdateBrandBinding binding;
    Api api;
    ProgressDialog progressDialog;
    String id;

    public UpdateBrandFragment() {
        // Required empty public constructor
    }


    // TODO: Rename and change types and number of parameters
    public static UpdateBrandFragment newInstance(String param1, String param2) {
        UpdateBrandFragment fragment = new UpdateBrandFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // return inflater.inflate(R.layout.fragment_update_brand, container, false);
    ...
    private void datavalidation() {
        if (!TextUtils.isEmpty(binding.brandName.getText().toString())) {

            datasubmit();
        } else {
            binding.brandName.setError("Please fill out this field");
    ...
    private void datasubmit() {
        progressDialog.show();
        api.updatebrand(binding.brandName.getText().toString(), id).enqueue(new Callback<JsonObject>() {
            @Override
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                progressDialog.dismiss();
                if (response.isSuccessful() && response.body() != null) {
                    Navigation.findNavController(getView()).navigate(R.id.action_global_manageBrandFragment);
